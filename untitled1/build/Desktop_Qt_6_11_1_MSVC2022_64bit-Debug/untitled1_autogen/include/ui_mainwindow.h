...
""));
        ...
        lineEdit_2->setStyleSheet(QString::fromUtf8("border-radius: 8;\n"
"background-color: rgb(255, 255, 255);"));
        ...
        name->setMaximumSize(QSize(360, 16777215));
...
"border-radius: 1.5px;"));
        ...
        QWidget::setTabOrder(name, lineEdit_2);
        ...
        QObject::connect(pushButton, &QPushButton::clicked, name, qOverload<>(&QLineEdit::copy));
        QObject::connect(pushButton, &QPushButton::clicked, lineEdit_2, qOverload<>(&QLineEdit::copy));
